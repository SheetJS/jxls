...
public class XLSForEachBlockReaderImplTest extends TestCase {
    ...
    public void testRead() throws IOException {
        ...
        XLSBlockReader reader = new XLSBlockReaderImpl(7, 7, mappings);
    ...
    public void testRead2() throws IOException {
        ...
        XLSBlockReader employeesReader = new XLSForEachBlockReaderImpl(7, 7, "department.staff", "employee", Employee.class);
        employeesReader.addBlockReader( employeeReader );
        SectionCheck loopBreakCheck = getLoopBreakCheck();
        employeesReader.setLoopBreakCondition( loopBreakCheck );
        XLSBlockReader departmentInfoReader = new XLSForEachBlockReaderImpl(0, 8, "departments", "department", Department.class);
        departmentInfoReader.addBlockReader( chiefReader );
        departmentInfoReader.addBlockReader( employeesReader );
        departmentInfoReader.addBlockReader( new XLSBlockReaderImpl(8, 8, new ArrayList()));
