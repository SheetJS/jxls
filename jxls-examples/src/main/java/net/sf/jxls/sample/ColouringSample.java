 ...
 */
public class ColouringSample {
    private static String templateFileName = "examples/templates/colouring.xls";
    private static String destFileName = "build/colouring_output.xls";
...
//        transformer.registerCellProcessor(new RedCellProcessor("department.staff"));
        transformer.registerCellProcessor(new RedCellProcessor2("department.staff"));
